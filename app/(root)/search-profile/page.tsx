              ...
              <div className='bg-white rounded-2xl shadow-sm overflow-hidden border border-pink-100 divide-y divide-pink-100'>
                ...
                >
                  ...
                  <div className='flex-1 text-left'>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>
                      Find profiles using GST number
                    </p>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div className='flex-1 text-left'>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>
                      Find profiles using Aadhaar number
                    </p>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div className='flex-1 text-left'>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>
                      Find profiles using PAN number
                    </p>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div className='flex-1 text-left'>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>
                      Find profiles using mobile number
                    </p>
                  </div>
                </button>
              </div>
