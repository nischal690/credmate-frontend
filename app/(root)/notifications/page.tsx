  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      title: 'Loan Approved',
      message:
        'Your loan application has been approved! Check your email for details.',
    ...
    },
    {
      ...
      message:
        'Please upload your latest bank statement to complete your application.',
      timestamp: '1 day ago',
      read: true,
    },
    {
      ...
      message:
        'Your EMI payment is due in 3 days. Please ensure sufficient balance.',
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    style={{
                      background:
                        'linear-gradient(45deg, rgba(162, 25, 94, 0.1), rgba(230, 92, 140, 0.1))',
                      borderRadius: '50%',
                      padding: '2.5rem',
                      display: 'flex',
                      alignItems: 'center',
                  ...
                  <motion.div
                    style={{
                      ...
                      borderRadius: '50%',
                      background:
                        'radial-gradient(circle, rgba(162, 25, 94, 0.1) 0%, rgba(162, 25, 94, 0) 70%)',
                      zIndex: 0,
                    }}
                  />
                  <motion.div
                    style={{
                      ...
                      borderRadius: '50%',
                      background:
                        'radial-gradient(circle, rgba(230, 92, 140, 0.1) 0%, rgba(230, 92, 140, 0) 70%)',
                      zIndex: 0,
                    }}
                  />
                </Box>
